...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    draw.text((205, 550), f"▶ Tιτlε : {title}", (51, 215, 255), font=font)
    draw.text((205, 590), f"😴 Dυrατιση : {duration}", (255, 255, 255), font=font)
    draw.text((205, 630), f"👀 Vιεωs : {views}", (255, 255, 255), font=font)
    draw.text(
        (205, 670),
